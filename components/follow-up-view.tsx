...
import PatientPlanView from "./view/patient-plan-view";
    ...
    <div className="grid grid-cols-2 grid-flow-row gap-6 gap-y-8 p-4">
      ...
      <div className="col-span-2">
        <div className="grid grid-cols-3 gap-4 grid-flow-row">
          ...
          <Card className="p-4 drop-shadow-md">
          ...
          <div className="col-span-2 grid grid-cols-2 grid-flow-row gap-6">
            <Card className="col-span-1 flex flex-col gap-2 p-4 drop-shadow-md">
              ...
              <p className="text-wrap">{patientFollowUp?.chiefComplaint}</p>
            </Card>
      ...
      <div className="col-span-2">
        <PatientPlanView recordId={followUpRecordId || ""} patientId={patientFollowUp?.patientId || ""} />
      </div>
    </div>
  );
};
